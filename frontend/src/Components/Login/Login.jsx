  ...
  return (
    <div className='login'>
      ...
      <div className="field">
        ...
        <input placeholder="Email" className="input-field" name="email"type="text" onChange={handleChange}/>
      </div>
      <div className="field">
        <svg
          className="input-icon"
        ...
        <input placeholder="Password" className="input-field"  name="password" type="password" onChange={handleChange}       />
      </div>
      <div className="btn">
